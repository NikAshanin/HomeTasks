...
class ORecognizer: UIGestureRecognizer {
    ...
    override func touchesMoved(_ touches: Set<UITouch>, with event: UIEvent) {
        ...
        guard isPointOnRadius(currentPoint: currentPoint) else {
        ...
        if strokePart == 0
            ...
            && isPointOnRadius(currentPoint: currentPoint) {
    ...
    // MARK: formula
    // x^2/a^2 + y^2/b^2 = 1
    func isPointOnRadius(currentPoint: CGPoint) -> Bool {
