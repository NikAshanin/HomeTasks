...
final class CalculatorViewController: UIViewController {
    ...
    @IBAction func changeLabelsButtonPressed(_ sender: UIButton) {
        ...
        for button in actionsButtons {
            for buttonDictionary in CalculatorService.changingButtonsNamesArray where button.titleLabel?.text == buttonDictionary[previousButtonDictionaryKey] {
    ...
    @IBAction func operationButtonPressed(_ sender: UIButton) {
        ...
        case _ where UnaryOperation.allRawValues.contains(operationString):
            ...
            mainLabelDouble = CalculatorService.unaryOperation(value: mainLabelDouble, operation: operation, withRadians: angleLabelString == "Rad") ?? 0
