...
struct FilmSources {
    ...
    static let E_1Title = "Star Wars: Episode I – The Phantom Menace"
    static let E_2Title = "Star Wars: Episode II – Attack of the Clones"
    static let E_3Title = "Star Wars: Episode III – Revenge of the Sith"
    static let E_4Title = "Star Wars: Episode IV - A New Hope"
    static let E_5Title = "Star Wars: Episode V - The Empire Strikes Back"
    static let E_6Title = "Star Wars: Episode VI - Return of the Jedi"
    static let E_7Title = "Star Wars: Episode VII - The Force Awakens"
    static let E_8Title = "Star Wars: Episode VIII - The Last Jedi"
    
    static let E_1Description = """
